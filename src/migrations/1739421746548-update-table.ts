...
export class UpdateTable1739421746548 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`shipping_product_infos\` ADD \`estimated_delivery_days_min\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`shipping_product_infos\` ADD \`estimated_delivery_days_max\` int NOT NULL`);
