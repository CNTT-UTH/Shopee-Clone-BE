...
export class CreateTable1738757823040 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`shippings\` (\`shipping_channel_id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`desc\` text NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`shipping_channel_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`orders\` (\`shipping_channel_id\` varchar(36) NOT NULL, \`total\` int NOT NULL DEFAULT '0', \`price_before_discount\` int NOT NULL DEFAULT '0', \`desc\` text NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`user_id\` varchar(36) NULL, \`shipping_detail_id\` int NULL, \`shop_id\` int NULL, UNIQUE INDEX \`REL_899f633317d513749082e4aadf\` (\`shipping_detail_id\`), PRIMARY KEY (\`shipping_channel_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`order_items\` (\`id\` int NOT NULL AUTO_INCREMENT, \`price\` int NOT NULL, \`price_before_discount\` int NOT NULL, \`quantity\` int NOT NULL DEFAULT '1', \`status\` enum ('0', '1', '2', '3') NOT NULL DEFAULT '0', \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`order_id\` varchar(36) NULL, \`product_id\` int NULL, \`product_variant_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`shops\` (\`id\` int NOT NULL AUTO_INCREMENT, \`description\` text NULL, \`name\` varchar(255) NOT NULL, \`phone\` varchar(255) NOT NULL, \`status\` enum ('0', '1', '2') NOT NULL DEFAULT '0', \`avatar\` text NULL, \`last_time_active\` datetime NULL, \`default_address_id\` int NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`user_id\` varchar(36) NULL, UNIQUE INDEX \`REL_bb9c758dcc60137e56f6fee72f\` (\`user_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`addresses\` (\`id\` int NOT NULL AUTO_INCREMENT, \`city\` varchar(255) NOT NULL, \`district\` varchar(255) NOT NULL, \`ward\` varchar(255) NOT NULL, \`address_line\` varchar(255) NOT NULL, \`phone_number\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`user\` varchar(36) NULL, \`shop\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`users\` (\`_id\` varchar(36) NOT NULL, \`username\` varchar(255) NOT NULL, \`password\` text NOT NULL, \`name\` varchar(255) NULL, \`email\` varchar(255) NOT NULL, \`dob\` datetime NULL, \`phone\` varchar(255) NULL, \`gender\` enum ('0', '1', '2') NOT NULL DEFAULT '2', \`is_shop\` tinyint NOT NULL DEFAULT 0, \`role\` enum ('0', '1') NOT NULL DEFAULT '0', \`refresh_token\` text NULL, \`refresh_token_mobile\` text NULL, \`verify\` enum ('0', '1', '2') NOT NULL DEFAULT '0', \`avatar\` text NULL, \`default_address_id\` int NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`cart_id\` int NULL, UNIQUE INDEX \`REL_cbfb19ddc0218b26522f9fea2e\` (\`cart_id\`), PRIMARY KEY (\`_id\`)) ENGINE=InnoDB`);
