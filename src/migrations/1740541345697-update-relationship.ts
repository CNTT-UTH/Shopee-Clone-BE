...
export class UpdateRelationship1740541345697 implements MigrationInterface {
    name = 'UpdateRelationship1740541345697'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`shops\` DROP INDEX IF EXISTS \`IDX_bf25720b50f0a6da3235c292d9\``);
        ...
        await queryRunner.query(`ALTER TABLE \`shops\` DROP INDEX IF EXISTS \`REL_bf25720b50f0a6da3235c292d9\``);
