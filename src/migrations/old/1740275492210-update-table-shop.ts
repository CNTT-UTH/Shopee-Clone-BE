...
export class UpdateTableShop1740275492210 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS \`user_id\` ON \`shops\``);
        await queryRunner.query(`DROP INDEX IF EXISTS \`FK_9d48998b97e7a97c4fddab1463b\` ON \`addresses\``);
        ...
        await queryRunner.query(
            `ALTER TABLE \`shops\` ADD CONSTRAINT \`FK_9d48998b97e7a97c4fddab1463b\` FOREIGN KEY (\`default_address_id\`) REFERENCES \`addresses\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
