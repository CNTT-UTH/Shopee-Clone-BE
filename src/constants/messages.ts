export const USERS_MESSAGES = {
    ...
    USERNAME_INVALID:
        "Username must be between 8 and 24 characters long, contain at least one uppercase letter, one lowercase letter, and one number, and must not contain any special characters",
