...
router
     ...
     .post(platformValidator, accessTokenValidator, authorizeRole([Role.User]), validationMiddleware(AddressDTO), addressController.createUserAdress)
...
router
     .route("/get-all-districts/:city_code")
     .get(addressController.getAllDistricts);
     

// Get wards by districts code
router
     .route("/get-all-wards/:district_code")
     .get(addressController.getAllWards);
